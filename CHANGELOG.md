...
#### [1.0.6](https://github.com/angelespejo/macos-app-trial-extender/compare/1.0.5...1.0.6)

- build(deps): bump minimatch from 3.1.2 to 3.1.5 [`#31`](https://github.com/angelespejo/macos-app-trial-extender/pull/31)
- build(deps-dev): bump svelte from 5.51.5 to 5.53.5 [`#30`](https://github.com/angelespejo/macos-app-trial-extender/pull/30)
- build(deps): bump devalue from 5.6.3 to 5.6.4 [`#36`](https://github.com/angelespejo/macos-app-trial-extender/pull/36)
- build(deps): bump quinn-proto from 0.11.12 to 0.11.14 in /src-tauri [`#33`](https://github.com/angelespejo/macos-app-trial-extender/pull/33)
- build(deps): bump basic-ftp from 5.0.5 to 5.2.0 [`#29`](https://github.com/angelespejo/macos-app-trial-extender/pull/29)
- build(deps): bump minimatch from 3.1.2 to 3.1.4 [`#28`](https://github.com/angelespejo/macos-app-trial-extender/pull/28)
- build(deps-dev): bump @sveltejs/kit from 2.50.0 to 2.52.2 [`#27`](https://github.com/angelespejo/macos-app-trial-extender/pull/27)
- build(deps-dev): bump svelte from 5.46.4 to 5.51.5 [`#26`](https://github.com/angelespejo/macos-app-trial-extender/pull/26)
- build(deps): bump tar from 7.5.3 to 7.5.7 [`#24`](https://github.com/angelespejo/macos-app-trial-extender/pull/24)
- build(deps): bump axios from 1.12.2 to 1.13.5 [`#25`](https://github.com/angelespejo/macos-app-trial-extender/pull/25)
- build(deps): bump bytes from 1.10.1 to 1.11.1 in /src-tauri [`#23`](https://github.com/angelespejo/macos-app-trial-extender/pull/23)
- build(deps): bump tar from 7.5.3 to 7.5.6 [`#20`](https://github.com/angelespejo/macos-app-trial-extender/pull/20)
- build(deps): bump lodash-es from 4.17.21 to 4.17.23 [`#21`](https://github.com/angelespejo/macos-app-trial-extender/pull/21)
- build(deps): bump lodash from 4.17.21 to 4.17.23 [`#22`](https://github.com/angelespejo/macos-app-trial-extender/pull/22)
- :construction_worker: build(all): up deps and devDeps [`103fa1f`](https://github.com/angelespejo/macos-app-trial-extender/commit/103fa1f0cf0c70148ef068690d3da90d729e614a)

#### [1.0.5](https://github.com/angelespejo/macos-app-trial-extender/compare/1.0.4...1.0.5)

> 18 January 2026

- build(deps): bump devalue from 5.3.2 to 5.6.2 [`#19`](https://github.com/angelespejo/macos-app-trial-extender/pull/19)
- build(deps-dev): bump @sveltejs/kit from 2.49.0 to 2.49.5 [`#18`](https://github.com/angelespejo/macos-app-trial-extender/pull/18)
- :truck: chore(all): update dependences and add new tests [`086ce5d`](https://github.com/angelespejo/macos-app-trial-extender/commit/086ce5d6eec4b6dccb1075e60d30f10a0b460845)
- :bookmark: feat(all): Release v1.0.5 [`4a37783`](https://github.com/angelespejo/macos-app-trial-extender/commit/4a37783c3b128011b9d6c9dc957db8a8454fdba2)
- :truck: chore(env): up cargo.lock [`3ca2315`](https://github.com/angelespejo/macos-app-trial-extender/commit/3ca2315befbc2bba06072a10bb74d2cab7366cc7)

#### [1.0.4](https://github.com/angelespejo/macos-app-trial-extender/compare/1.0.3...1.0.4)

> 24 November 2025

- build(deps-dev): bump vite from 7.1.5 to 7.1.11 [`#16`](https://github.com/angelespejo/macos-app-trial-extender/pull/16)
- :truck: chore(all): up deps [`2fd56b2`](https://github.com/angelespejo/macos-app-trial-extender/commit/2fd56b2e2b1976e9a53d25e4181cff6548544815)
- :bookmark: feat(all): Release v1.0.4 [`eb47393`](https://github.com/angelespejo/macos-app-trial-extender/commit/eb473934c9fab3ec02c1547defc7315b0611510a)
- :memo: docs(env): change lock file [`c6567aa`](https://github.com/angelespejo/macos-app-trial-extender/commit/c6567aa7b14ee746c95e2071901fea532b264480)
...
- :bookmark: feat(all): Release v1.0.3 [`289fb3a`](https://github.com/angelespejo/macos-app-trial-extender/commit/289fb3af7e3379fc1eafdcf11cfc66d2e582e26f)
